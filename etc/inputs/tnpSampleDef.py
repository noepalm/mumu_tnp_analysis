...
Parking_X = {
    # 'data' : tnpSample('data', "/eos/cms/store/user/crovelli/HLT_DoubleMu/DoubleMuTnP_2022D_LowMass0.root"),
    # 'MC' : tnpSample('MC', "/eos/cms/store/user/crovelli/HLT_DoubleMu/DoubleMuTnP_2022D_LowMass0.root"),
